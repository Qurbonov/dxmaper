...
import FormN2Apis from './formN2.services';
            ...
            <Spin spinning={loading} size={'large'} style={{minHeight: 80}}>
                {orgData.length > 0 &&
                    <div>
                        ...
                        <div className={classes.orgInfo}>
                            <div className={classes.key}>{t("Director")}:</div>
                            <div className={classes.value}>{orgFullData[0]?.Director}</div>
                        </div>
                        <div className={classes.orgInfo}>
                            <div className={classes.key}>{t("Accounter")}:</div>
                            <div className={classes.value}>{orgFullData[0]?.Accounter}</div>
                        </div>
                        <div className={classes.orgInfo}>
                            <div className={classes.key}>{t("INN")}:</div>
                            <div className={classes.value}>{orgFullData[0]?.INN}</div>
                        </div>
                        <div className={classes.orgInfo}>
                            <div className={classes.key}>{t("ContactInfo")}:</div>
                            <div className={classes.value}>{orgFullData[0]?.ContactInfo}</div>
                        </div>
                        <div className={classes.orgInfo}>
                            <div className={classes.key}>{t("Adress")}:</div>
                            <div className={classes.value}>{orgFullData[0]?.Adress}</div>
                        </div>
                        <div>
                            <div
                                style={{
